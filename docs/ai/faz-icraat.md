...
| **İlk klipler basılmadan ÖNCE** | 🔴 **CANARY = İLK 2 SAHNE + EN EPİK 2 SAHNE. Dört kare, sabit** (Mami, 2026-08-08: *"canary hep ilk 2 sahne ve en epik 2 sahne"*). İlk ikisi **dünyayı ve referansı** sınar — film oradan doğar; epik ikisi **motorun tavanını** sınar — en pahalı, en çok kırılan, beğeniyi belirleyen kare orası. ⚠ Eski "8 klip · risk sınıfından türet" yöntemi EMEKLİ: her projede yeniden tartışılıyordu ve iki katı kare istiyordu. AGY tarif eder, Sol çürütür, **hükmü Mami verir** → `<Ad>_CANARY-LOCK.md` (kim ne zaman çağrılır ve sonucu ne anlama gelir: **`docs/ai/DORTLU-MASA.md`**). Ölçüldü: canary'siz basılan 6 klibin 6'sı bozuk çıktı. ⚠ **`%42.6` rakamı 2026-08-05'te ÇEKİLDİ** — repoda kaynağı yoktu ve içindeki bir ölçüm bilinen-yanlıştı (`Sorunları Birlikte Çözüyoruz` 9 revize dosyasına rağmen "%0" yazıyordu). Gerçek dağılım **%11 – %74** ve ortalama bunu gizliyor; sorulacak soru **"%11 ile %74 arasındaki tek yapısal fark ne?"** |
