...
// Scene data for all 58 scenes of "Kuvvet ve Kuvvetin Ölçülmesi" starring @efe
const efeScenes = {
  1: {
...
let mdContent = `# MAMILAS — Kuvvet ve Kuvvetin Ölçülmesi (58 Sahne) MASTER RenderMan Prompt Paket\n\n`;
mdContent += `> **Ana Karakter:** @efe (Mira / Ali / Can bu senaryoda yoktur; yalnız @efe etiketlendi).\n`;
...
mdContent += `> **Karakter Kilit Hassasiyeti:** Sahnede @efe gerçekten varsa etiketlendi; diyagram/obje/araç sahnelerinde KESİNLİKLE karakter tag'i yazılmadı.\n`;
mdContent += `> **Fiziksel Tarif:** Sıfır fiziksel tarif.\n`;
mdContent += `> **Sert Negatif Kilitler:** Siyahi yok, Asyalı yok, İngilizce metin yok.\n\n---\n\n`;
...
console.log('Successfully saved EFE MASTER prompts to:', mdFilePath);
