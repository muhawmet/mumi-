...
- `K09 | VO8+9+10 "Kuvvetin en basit tanımı da buydu işte: duran bir cismi hareket ettiren, h` — üç katman derinlik YOK · STYLE 129 kelime (tavan 110)
...
- `K14 | VO15 "Oyun hamurunu avucunda sıktığında hamurun şekli tamamen değişti; demek ki cisi` — yazı taşıyan karede HARF HARF heceleme + diakritik YOK · STYLE 146 kelime (tavan 110)
...
- `K19 | VO22 "Kuvveti ölçmek için dinamometre adı verilen bir araç kullanılıyordu."` — STYLE 140 kelime (tavan 110)
- `K20 | VO23 "Şeffaftı, içinde esnek bir yay vardı."` — STYLE 126 kelime (tavan 110)
- `K21 | VO24 "Kancasına bir cisim asıldığında kuvvet yayı aşağı doğru çekiyor, yay uzuyordu;` — STYLE 133 kelime (tavan 110)
- `K22 | VO25+26 "Ölçtüğü sonucu yazarken de bir birime ihtiyacı vardı: o birim, ünlü bilim i` — STYLE 123 kelime (tavan 110)
- `K23 | VO27 "Yani bir kuvvet ölçüldüğünde sonuç '5 Newton' ya da kısaca '5 N' diye söyleniy` — STYLE 121 kelime (tavan 110)
- `K24 | VO28 "Derken Mira iki farklı dinamometre gördü."` — STYLE 142 kelime (tavan 110)
- `K25 | VO29 "Birinin içinde kalın bir yay vardı, diğerinde incecik bir yay."` — STYLE 122 kelime (tavan 110)
...
- `K28 | VO32 "İnce yaylı olana hafif bir silgi astığında yay hemen esnedi."     [A KARESİ — ` — STYLE 138 kelime (tavan 110)
...
- `K32 | VO36b "ancak ağır bir taş astığında esnedi."` — STYLE 137 kelime (tavan 110)
- `K33 | VO37 "Çünkü ağır bir sırt çantasını ölçmeye kalksak ince yay kopabilir ya da bozulab` — STYLE 153 kelime (tavan 110)
- `K34 | VO38+39 "İşte o zaman kalın ve sert yaylı dinamometreler kullanılıyordu. Kalın yaylı` — STYLE 164 kelime (tavan 110)
...
- `K37 | VO43 "Kancaya önce küçük bir silgi astı, yay az uzadı;"     [A KARESİ — K38 bundan r` — STYLE 154 kelime (tavan 110)
- `K39 | VO46 "Çünkü dinamometrenin içindeki yay esnek bir maddeydi ve esnek maddeler, üzerle` — STYLE 138 kelime (tavan 110)
...
- `K42 | VO49 "İşte bu yüzden her dinamometrenin üzerinde yazan maksimum ölçüm değerine dikka` — STYLE 129 kelime (tavan 110)
